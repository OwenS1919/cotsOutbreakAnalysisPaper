function probVec = survFuncWeibWeib(tVec, paramsStruct, tVec2)
% survFuncWeibWeib() will calculate values for a piecewise survivorship
% curve combining two Weibull shaped death rate functions, as described in
...
% tVec2 - optional - if specified, use as lower limits for integrations
    ...
    % larva will survive between from tVec2(t) to tVec(t) - default is
    % tVec2 = zeros(), a.k.a. probVec(t) will be the probability that a
    % larva survives from 0 to tVec(t)
